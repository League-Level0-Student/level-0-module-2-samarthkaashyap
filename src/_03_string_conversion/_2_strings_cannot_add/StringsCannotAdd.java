...
String fourAsString = JOptionPane.showInputDialog(null, "enter number 4");			
			// 3) Ask the user to enter number 6 and hold it in the variable sixAsString 
String sixAsString = JOptionPane.showInputDialog(null, "enter number 6");			
...
String fiveAsString = JOptionPane.showInputDialog(null, "enter number5");
